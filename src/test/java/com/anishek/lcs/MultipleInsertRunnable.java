...
public class MultipleInsertRunnable implements Callable<Long> {
    ...
    public MultipleInsertRunnable(long start, long stop, Map<String, Object> otherArguments) {
        this.start = start;
        this.stop = stop;
    ...
    public Long call() throws Exception {
        ...
        for (long i = start; i < stop; i++) {
            ...
            Statement statement = QueryBuilder.insertInto("activity_log", "mtestone")
                    .value("id", i)
                    .value("client_id", 11)
            ...
            for (int j = 0; j < 10; j++) {
                statement = QueryBuilder.insertInto("activity_log", "mtesttwo")
                        .value("id", i)
